...
namespace Account_Payable1
{
    ...
    public partial class SearchVendor : Form
    {
        ...
        {
            string query = " SELECT NUM_Vendor_ID, CHR_companyName, CHR_companyType, NUM_phone, CHR_email, CHR_country, CHR_city, CHR_address_ FROM TBL_VENDOR WHERE (" +
                "NUM_Vendor_ID LIKE '%{0}%'" + searchV.Text.Trim() + " OR NUM_Vendor_ID LIKE '%{0}%')" + searchV.Text.Trim();


            BindingSource bs = new BindingSource();
            bs.DataSource = dataGridView1.DataSource;
            bs.Filter = "[CHR_companyName] Like '%" + searchV.Text + "%'";
            dataGridView1.DataSource = bs;
        }

        private void SearchVendor_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'accountsPayableDataSet.TBL_VENDOR' table. You can move, or remove it, as needed.
            this.tBL_VENDORTableAdapter.Fill(this.accountsPayableDataSet.TBL_VENDOR);
            // TODO: This line of code loads data into the 'accountsPayableDataSet2.TBL_VENDOR' table. You can move, or remove it, as needed.
            //this.tBL_VENDORTableAdapter1.Fill(this.accountsPayableDataSet2.TBL_VENDOR);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewRow item in this.dataGridView1.SelectedRows)
            {
                ...
                con.Open();
                string query = "DELETE FROM TBL_VENDOR WHERE NUM_Vendor_ID= " + vendorid + ";";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
                query = "DELETE FROM TBL_INVOICE WHERE NUM_invoiceID= " + vendorid + ";";
