    ...
    public partial class Invoices : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in this.dataGridView2.SelectedRows)
            {
                ...
                con.Open();
                string query = "DELETE FROM TBL_INVOICE_ITEMS WHERE invoiceID= " + invoice + ";";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.ExecuteNonQuery();
                query = "DELETE FROM TBL_INVOICE WHERE invoiceID= " + invoice + ";";
        ...
        {
            string query = " SELECT * FROM TBL_INVOICE WHERE created_date >= '" + dateTimePicker1.Value.Date.ToString("yyyyMMdd") + " ' AND created_date <= '" +
